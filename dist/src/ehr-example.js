...
define('text!templates/navigation.html',[],function () { return '<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">\n  <div class="container">\n    <div class="navbar-header">\n      <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">\n        <span class="sr-only">Toggle navigation</span>\n        <span class="icon-bar"></span>\n        <span class="icon-bar"></span>\n        <span class="icon-bar"></span>\n      </button>\n      <span class="navbar-brand">Your EHR</span>\n    </div>\n    <div class="collapse navbar-collapse">\n      <ul class="nav navbar-nav">\n        <li class="active home"><a class="load-page" href="#">Home</a></li>\n        <li class="eprescribe"><a class="load-page" href="#/patients">e-Prescribing</a></li>\n        <li class="dropdown priorauth">\n          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Prior Authorization <b class="caret"></b></a>\n          <ul class="dropdown-menu">\n            <li><a class="load-page" href="#/dashboard">Task List</a></li>\n            <li><a class="load-page" href="#/requests/new">New Prior Authorization</a></li>\n            <li class="divider"></li>\n            <li><a class="load-page" href="#/help">Contact CoverMyMeds</a></li>\n          </ul>\n        </li>\n      </ul>\n    </div><!--/.nav-collapse -->\n  </div>\n</div>\n\n<div class="container">\n  <div id="page-load-target">\n    <!-- Additional views loaded here -->\n  </div>\n</div><!-- /.container -->\n';});

/*jslint sloppy: true, nomen: true */
/*global define: false */
define('views/navigation',[
    'jquery',
    'underscore',
    'backbone',
...
define('text!templates/patients/list.html',[],function () { return '<div id="patients-list" class="template">\n  <h1>Patients\n  <a href="#/patients/new" class="btn btn-small btn-success">Add patient</a>\n  </h1>\n\n  <% if (patientsCollection.length < 1) { %>\n  <h2>No Patients</h2>\n  <% } %>\n\n  <table class="table table-striped">\n    <tr class="header">\n      <th class="open">Open PAs</th>\n      <th>Patient Name</th>\n      <th class="remove">Remove</th>\n    </tr>\n    <% patientsCollection.each(function (patient) { %>\n    <tr class="patients">\n      <td class="open">\n        <span class="label label-info"><%= patient.get(\'requestsCollection\').length %></span>\n      </td>\n      <td>\n        <a href="#/patients/<%= patient.id %>">\n          <%= patient.get(\'first_name\') %> <%= patient.get(\'last_name\') %> (<%= patient.get(\'date_of_birth\') %>)\n        </a>\n      </td>\n      <td class="remove">\n        <a href="#/patients/<%= patient.id %>/destroy" class="btn btn-xs btn-danger">X</a>\n      </td>\n    </tr>\n    <% }); %>\n  </table>\n</div>\n';});

/*jslint sloppy: true, nomen: true */
/*global define: false */
define('views/patients/list',[
    'jquery',
    'underscore',
    'backbone',
...
define('text!templates/requests/list.html',[],function () { return '<div class="template">\n  <h1>Your Dashboard</h1>\n  <div id="dashboard"></div>\n</div>\n';});

/*jslint sloppy: true, nomen: true */
/*global define: false, localStorage: false, CMM_API_CONFIG: false */
define('views/requests/list',[
    'jquery',
    'backbone',
...
define('text!templates/requests/add-eprescribe.html',[],function () { return '<div id="request-add" class="template">\n  <h3>New Prescription</h3>\n\t<fieldset>\n    <legend><%= patient.get(\'first_name\') %> <%= patient.get(\'last_name\') %> (<%= patient.get(\'date_of_birth\') %>)</legend>\n\n\t\t<input type="hidden" id="first_name" name="request[patient][first_name]" value="<%= patient.get(\'first_name\') %>">\n\t\t<input type="hidden" id="last_name" name="request[patient][last_name]" value="<%= patient.get(\'last_name\') %>">\n\t\t<input type="hidden" id="date_of_birth" name="request[patient][date_of_birth]" value="<%= patient.get(\'date_of_birth\') %>">\n\t\t<select name="request[state]" style="display: none;">\n\t\t  <option value="<%= patient.get(\'state\') %>"></option>\n\t\t</select>\n\n\t\t<p>\n\t\t\t<label for="drug">Drug</label>\n\t\t    <input class="form-control" id="drug" name="request[prescription][drug_id]">\n\t\t</p>\n\n\t\t<p>\n\t\t\t<label for="quantity">Quantity</label>\n\t\t\t<input class="form-control" name="request[prescription][quantity]">\n\t\t</p>\n\n    <p>\n      <label for="directions">Directions</label>\n      <select name="request[prescription][frequency]" class="form-control">\n        <option value="">Directions / Sig</option>\n        <option value="qD">qD - EVERY DAY</option>\n        <option value="BID">BID - TWICE A DAY</option>\n        <option value="TID">TID - THREE A DAY</option>\n        <option value="QID">QID - FOUR A DAY</option>\n        <option value="PRN">PRN - AS NEEDED</option>\n        <option value="UD">UD - AS DIRECTED</option>\n      </select>\n    </p>\n\n    <p>\n      <label for="refills">Refills</label>\n      <select name="request[prescription][refills]" class="form-control">\n        <option value="">Refills</option>\n        <option value="0">0</option>\n        <option value="1">1</option>\n        <option value="2">2</option>\n        <option value="3">3</option>\n        <option value="4">4</option>\n        <option value="5">5</option>\n        <option value="6">6</option>\n      </select>\n    </p>\n\n    <p>\n      <label>\n        Dispense as written\n        <input type="checkbox" name="request[prescription][dispense_as_written]" id="yes" value="yes">\n      </label>\n    </p>\n\n\t\t<p>\n      <% if (patient.get(\'requestsCollection\').length === 0) { %>\n\t\t\t<a href="#/patients" class="btn btn-default">Cancel</a>\n      <% } else { %>\n\t\t\t<a href="#/patients/<%= patient.id %>" class="btn btn-default">Cancel</a>\n      <% } %>\n\t\t\t<button class="btn btn-primary create">Save</button>\n\t\t</p>\n\n\t</fieldset>\n</div>\n';});

/*jslint sloppy: true, nomen: true */
/*global window: false, define: false, CMM_API_CONFIG: false */
define('views/requests/add-eprescribe',[
    'jquery',
    'underscore',
    'backbone',
...
define('text!templates/requests/add-priorauth.html',[],function () { return '<div id="request-add" class="template">\n  <fieldset>\n  \t<legend>New PA Request</legend>\n\n  \t<p>\n  \t\t<label for="first_name">First Name</label>\n  \t\t<input class="form-control" id="first_name" name="request[patient][first_name]">\n  \t</p>\n\n  \t<p>\n  \t\t<label for="last_name">Last Name</label>\n  \t\t<input class="form-control" id="last_name" name="request[patient][last_name]">\n  \t</p>\n\n  \t<p>\n  \t\t<label for="date_of_birth">Date of Birth</label>\n  \t\t<input class="form-control" id="date_of_birth" name="request[patient][date_of_birth]">\n  \t</p>\n\n  \t<p>\n  \t\t<label for="state">State</label>\n  \t\t<select class="form-control" id="state" name="request[state]">\n  \t\t\t<option>Select&hellip;</option>\n        <option value="AL">Alabama</option> \n        <option value="AK">Alaska</option> \n        <option value="AZ">Arizona</option> \n        <option value="AR">Arkansas</option> \n        <option value="CA">California</option> \n        <option value="CO">Colorado</option> \n        <option value="CT">Connecticut</option> \n        <option value="DE">Delaware</option> \n        <option value="DC">District Of Columbia</option> \n        <option value="FL">Florida</option> \n        <option value="GA">Georgia</option> \n        <option value="HI">Hawaii</option> \n        <option value="ID">Idaho</option> \n        <option value="IL">Illinois</option> \n        <option value="IN">Indiana</option> \n        <option value="IA">Iowa</option> \n        <option value="KS">Kansas</option> \n        <option value="KY">Kentucky</option> \n        <option value="LA">Louisiana</option> \n        <option value="ME">Maine</option> \n        <option value="MD">Maryland</option> \n        <option value="MA">Massachusetts</option> \n        <option value="MI">Michigan</option> \n        <option value="MN">Minnesota</option> \n        <option value="MS">Mississippi</option> \n        <option value="MO">Missouri</option> \n        <option value="MT">Montana</option> \n        <option value="NE">Nebraska</option> \n        <option value="NV">Nevada</option> \n        <option value="NH">New Hampshire</option> \n        <option value="NJ">New Jersey</option> \n        <option value="NM">New Mexico</option> \n        <option value="NY">New York</option> \n        <option value="NC">North Carolina</option> \n        <option value="ND">North Dakota</option> \n        <option value="OH">Ohio</option> \n        <option value="OK">Oklahoma</option> \n        <option value="OR">Oregon</option> \n        <option value="PA">Pennsylvania</option> \n        <option value="RI">Rhode Island</option> \n        <option value="SC">South Carolina</option> \n        <option value="SD">South Dakota</option> \n        <option value="TN">Tennessee</option> \n        <option value="TX">Texas</option> \n        <option value="UT">Utah</option> \n        <option value="VT">Vermont</option> \n        <option value="VA">Virginia</option> \n        <option value="WA">Washington</option> \n        <option value="WV">West Virginia</option> \n        <option value="WI">Wisconsin</option> \n        <option value="WY">Wyoming</option>\n  \t\t</select>\n    </p>\n\n  \t<p>\n  \t\t<label for="drug">Drug</label>\n      <input class="form-control" id="drug" name="request[prescription][drug_id]">\n  \t</p>\n\n  \t<p>\n  \t\t<label for="form">Form</label>\n  \t\t<input class="form-control" id="form" name="request[form_id]">\n  \t</p>\n\n    <p>\n      <a href="#/dashboard" class="btn btn-default">Cancel</a>\n      <button id="create" class="btn btn-primary">Create</button>\n    </p>\n\n  </fieldset>\n</div>';});
 ...
 */
define('views/requests/add-priorauth',[
    'jquery',
    'underscore',
    'backbone',
...
define('text!templates/pharmacies/list.html',[],function () { return '<div id="pharmacies-list" class="template">\n  <h1>Pharmacies</h1>\n\n  <% if (pharmacies.length < 1) { %>\n  <h2>No Pharmacies</h2>\n  <% } %>\n\n  <table class="table table-striped dt">\n    <thead>\n      <tr>\n        <th>Pharmacy</th>\n      </tr>\n    </thead>\n    <tbody>\n      <% _.each(pharmacies, function (pharmacy, index) { %>\n        <tr>\n          <td>\n            <label for="<%= index %>">\n              <input type="radio" id="<%= index %>" name="pharmacies" value="<%= pharmacy %>"> <%= pharmacy %>\n            </label>\n          </td>\n        </tr>\n      <% }); %>\n    </tbody>\n  </table>\n\n  <a href="#/patients/<%= patientId %>" class="btn">Cancel</a>\n  <button class="finish btn btn-primary">Finish</button>\n</div>\n';});
...
for(var k=1;k<e.length;k++){h=e.charAt(k);if(-1=="0123456789.".indexOf(h))return null;if("."==h){if(j)return null;j=!0}}return"numeric"},function(e){var h=Date.parse(e);return null!==h&&!isNaN(h)||"string"===typeof e&&0===e.length?"date":null},function(e){return"string"===typeof e&&-1!=e.indexOf("<")&&-1!=e.indexOf(">")?"html":null}]);h.fn.DataTable=j;h.fn.dataTable=j;h.fn.dataTableSettings=j.settings;h.fn.dataTableExt=j.ext};"function"===typeof define&&define.amd?define('datatables',["jquery"],L):jQuery&&!jQuery.fn.dataTable&&
L(jQuery)})(window,document);

define('datatablesbootstrap',[],function () { 
...
define('text!templates/help.html',[],function () { return '<div class="template"></div>\n';});
...
define("select2", ["bootstrap"], function(){});
...
;
define("cmmplugins", ["jquery","select2","cmmconfig"], function(){});
...
define("bootstrapDatepicker", ["bootstrap"], function(){});
